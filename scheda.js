...
function aggiornaPunti(checkbox) {
  const puntiDisponibiliElement = document.getElementById("puntiDisponibili");
  const puntiDisponibili = parseInt(puntiDisponibiliElement.textContent);
  const punti = parseInt(checkbox.getAttribute("data-punti"));
  ...
  puntiDisponibiliElement.textContent = puntiDisponibili;
}
...
const fieldsets = document.querySelectorAll('.accordion');

fieldsets.forEach(fieldset => {
  const toggleButton = fieldset.querySelector('.toggle-button');
